...
module UserModule =
    ...
    type FieldValidationResult = Result<UserField, UserError>
    ...
    let createUser id email =
        ...
        let idValidationResult = validateId id
        let emailValidationResult = validateEmail email

        let fieldValidationResults = (idValidationResult, emailValidationResult)

        match fieldValidationResults with
